    ...
    return (
        <div className="mt-20 pb-5">
            ...
            <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">
                Explore diverse job opportunities tailored to your skills. Start your <br /> career journey today!
            </div>
            ...
            <div>
                ...
                focus-visible:[&_button]:opacity-100"
                nextControlIcon={<IconArrowRight className="h-9 w-9" />}
                previousControlIcon={<IconArrowLeft className="h-9 w-9" />}
                >
                    {
